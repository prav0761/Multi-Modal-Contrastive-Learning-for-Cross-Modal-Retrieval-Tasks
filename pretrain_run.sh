...
#SBATCH -J pretrain12 # Job name
#SBATCH -o ot12.txt       # Name of stdout output file
#SBATCH -e et12.txt      # Name of stderr error file
#SBATCH -p v100           # Queue (partition) name
#SBATCH -N 1               # Total # of nodes (must be 1 for serial)
#SBATCH -n 1               # Total # of mpi tasks (should be 1 for serial)
#SBATCH -t 15:30:00        # Run time (hh:mm:ss)
